							...
							<li class="ui-body ui-body-b">
								<fieldset class="ui-grid-a">
									<div class="ui-block-a"><a data-role="button">
										<xsl:attribute name="href">/html/assignShows.html?path=<xsl:apply-templates select="/browseBean/path" /></xsl:attribute>
										Assign Shows</a></div>
									<div class="ui-block-b"><a data-role="button">
										<xsl:attribute name="href">/html/assignMovies.html?path=<xsl:apply-templates select="/browseBean/path" /></xsl:attribute>
										Assign Movies</a></div>
								</fieldset>
							</li>
