...
public class HtmlTemplateEngineServlet extends HttpServlet
{
	...
	public HtmlTemplateEngineServlet( OpenMMServerRuntime runtime )
	{
		config = runtime.getConfig();
		htmlEngine = new HtmlTemplateEngine( runtime, bundle );
	...
	protected void doPost( HttpServletRequest req, HttpServletResponse resp ) throws ServletException, IOException
	{
		try
		{
			...
			try
			{
				bean = htmlEngine.createPageBean( uri, req, actionResult );
			}
			catch ( ClassNotFoundException e )
			{
				// ignore
