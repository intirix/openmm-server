...
public class TestAdminUsersResetPassword extends XMLTestCase
{
	...
	public void testXml() throws Exception
	{
		...
		engine.renderPage( "adminUsersResetPassword.xml", engine.createPageBean( "adminUsersResetPassword.xml", req, null ), buffer );
		System.out.println( buffer.toString() );
		assertXpathEvaluatesTo( userBean.getUsername(), "adminUsersResetPasswordBean/user/username", buffer.toString() );
